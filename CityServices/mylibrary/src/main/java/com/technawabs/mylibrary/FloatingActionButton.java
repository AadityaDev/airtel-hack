 ...
 */
package com.technawabs.mylibrary;
...
public class FloatingActionButton extends FrameLayout {
     ...
     * @param contentParams
     */
    public FloatingActionButton(Context context, LayoutParams layoutParams, int theme,
     ...
     */
    public void setPosition(int position, LayoutParams layoutParams) {
